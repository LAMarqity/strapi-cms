...
export interface ApiCaseCase extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Case studies showcasing client work and results';
    displayName: 'Case';
    pluralName: 'cases';
    singularName: 'case';
  };
...
export interface ApiCourseEventCourseEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Specific scheduled instances of courses';
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Courses and training sessions';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
